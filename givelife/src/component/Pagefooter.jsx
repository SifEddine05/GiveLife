      ...
      <footer className="relative text-primary z-10 pt-20 lg:pt-[120px] text-white bg-[#22262F]">
        <div className="container">
          <div className="flex flex-wrap text-center">
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
              <div className="mb-10 w-full">
                ...
                <ul className="text-[#AFAFAF]">
                  <li className="mb-4">Home</li>
                  <li className="mb-4">Donate</li>
                  <li className="mb-4">Create Donation</li>
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
              <div className="mb-10 w-full">
                <h4 className="text-dark mb-9 text-lg font-semibold">Get In Touch</h4>
                <ul className="text-[#AFAFAF]">
            ...
            <div className="w-full px-4 sm:w-1/2 lg:w-2/12">
              <div className="mb-10 w-full">
                <h4 className="text-dark mb-9 text-lg font-semibold">Address</h4>
                <ul className="text-[#AFAFAF]">
                  <li className="mb-4">2464 Royal Ln. Mesa, New Jersey 45463</li>
                </ul>
              </div>
            </div>
          ...
          <div>
            ...
            <div className="w-full flex justify-center py-8">Made with 💚 by Andromeda</div>
          </div>
        </div>
